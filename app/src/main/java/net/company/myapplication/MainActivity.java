package net.company.myapplication;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String webViewUrl = "http://books.neugrp.com/";
...
//            Toast.makeText(MainActivity.this, "Unexpected SSL error occurred.Reload page again.", Toast.LENGTH_SHORT).show();
    ...
    static public void setAppLocale(Context context, String lang) {
